...
WORKDIR /app
COPY --from=build /app/target/fuel_consumption.jar /app/app.jar

ENTRYPOINT ["java", "--module-path", "/opt/javafx-sdk-21/lib", "--add-modules", "javafx.controls,javafx.fxml", "-jar", "/app/app.jar"]
